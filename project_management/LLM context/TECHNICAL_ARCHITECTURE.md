...
**Last reviewed:** 2026-07-11 (§2 news layer reworked to **team-centric collection** (pipeline Stage A) — 3 native RSS sources/team → `team_news_raw` entity + reworked `fetchers/news.py`; supersedes the v1 player-news collector)
