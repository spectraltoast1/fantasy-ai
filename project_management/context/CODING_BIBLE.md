...
- **Bank before you run anything destructive — the commit FLOOR.** The 3-commit cap bounds sprawl;
  ...
  can be hit, this limits what is at risk when something is.** **A bank-before-destructive commit
  counts toward the cap** — if that takes you to three, close down; that is the cap working.
