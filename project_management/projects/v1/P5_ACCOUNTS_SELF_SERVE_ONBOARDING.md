...
**Created:** 2026-07-26 · **Updated:** 2026-08-15 — **S4a + S4b + S4c SHIPPED**; S4 is **S4a–S4f** (Will's live link test found two defects and forced a *pending* lifecycle) · **Status:** Active — **S4d next, briefed** · **Track:** Critical spine — **the biggest single block** · **Depends on:** P0 (keyed reads + viewer-as-data), P2 (the ingestion pipeline it automates) · **Est:** 12 sessions (S4 became six) · **Session docs:** `sessions/v1/P5-Self_Serve/`
