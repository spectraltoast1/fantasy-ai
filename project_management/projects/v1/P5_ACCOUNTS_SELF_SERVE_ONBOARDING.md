...
- **Identity mapping — HALF CLOSED, reassigned to S4 (2026-08-13).** S2 settled the **model**: the viewer
  ...
  Sleeper username to an app user is **connect-flow work → S4**.
