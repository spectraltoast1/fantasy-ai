...
**Created:** 2026-07-26 · **Updated:** 2026-08-14 — **S4a + S4b SHIPPED + ENDORSED**; S4 is **S4a–S4e** (the dossier job moved out of S4c) · **Status:** Active — **S4c next, briefed** · **Track:** Critical spine — **the biggest single block** · **Depends on:** P0 (keyed reads + viewer-as-data), P2 (the ingestion pipeline it automates) · **Est:** 11 sessions (S4 became five) · **Session docs:** `sessions/v1/P5-Self_Serve/`
